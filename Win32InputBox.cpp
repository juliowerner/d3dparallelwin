...
03/10/2006
- forgot to pass the parent window handle to the param struct in InputBox()
...
// returns same value as DialogBoxIndirectParam()
INT_PTR CWin32InputBox::InputBoxEx(WIN32INPUTBOX_PARAM *param)
{
  ...
  LPDLGTEMPLATE dlgTemplate = NULL;
  ...
  MSDN_DLGTEMPLATEEX *dlgTemplateEx =
    IsDlgTemplateExtended((LPDLGTEMPLATE) dlgTemplate) ? (MSDN_DLGTEMPLATEEX *) dlgTemplate : NULL;

  if (dlgTemplateEx != NULL)
  {
